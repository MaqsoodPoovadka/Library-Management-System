...
<?php
                                    if (isset($_GET['key'])) {
                                        //$stype=	$_GET['stype'];
										$key  = $_GET["key"];
                                        //$searchq = mysqli_query($connect, "SELECT * FROM `books` WHERE title LIKE '%$key%' OR author LIKE '%$key%'");
										$searchq = mysqli_query($connect, "SELECT * FROM `books` WHERE title LIKE '%$key%' OR author LIKE '%$key%'");
                                        //$row = mysqli_fetch_assoc($searchq);
                                        
										$searchres = mysqli_num_rows($searchq);
                                    }
                                ?>
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h6 class="heading-tittle font-italic">Result: <b><?php echo $searchres;?> Result Found</b></h6>
							<div class="row">

								<?php
									
									while ($rows = mysqli_fetch_assoc($searchq)) { 
