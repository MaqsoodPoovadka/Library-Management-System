...
<?php
                                    if (isset($_GET['lang'])) {
                                        ...
                                        $sql = mysqli_query($connect, "SELECT * FROM `languages` WHERE language = '$lang'");
	...
	<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			...
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
				<span><?php echo $row['language'];?></span></h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
					...
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">
								...
								<?php
									$crun = mysqli_query($connect, "SELECT * FROM `books` WHERE lang = '$lang'");
