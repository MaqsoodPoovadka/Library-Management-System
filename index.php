					...
					<div class="wrapper">
						<!-- first section -->
							<?php
									...
									$crun = mysqli_query($connect, "SELECT * FROM `categories` LIMIT 3");
									while ($row = mysqli_fetch_assoc($crun)) { 
                  
                    		?>
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic"><?php echo $row['category'];?></h3>
							<div class="row">

								<?php
									
									$brun = mysqli_query($connect, "SELECT * FROM `books` WHERE category='$row[category]' LIMIT 3");
									while ($rows = mysqli_fetch_assoc($brun)) { 
						...
						<!-- second section --
                    		...
                    		?>
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic"><?php echo $rows['category'];?></h3>
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
